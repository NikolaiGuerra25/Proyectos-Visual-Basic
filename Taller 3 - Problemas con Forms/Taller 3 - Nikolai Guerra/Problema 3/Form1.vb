    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Do
            ...
            Do While (contador1 = 0)
                Try
                    opcion = InputBox("Seleccione una opcion ingresando el numero" & vbNewLine &
                                          "1. Convertir Euro a dolares" & vbNewLine &
                                          ...
                                          "7. Convertir dolares a libras esterlinas" & vbNewLine &
                                          "8. Convertir libras esterlinas a dolares", "Bienvenido al programa conversor de divisas")
            ...
            Select Case opcion1
                Case 1
                    ...
                    MsgBox("La conversion de " & moneda & " euros a dolares son: $" & newMoneda)
                Case 2
                    moneda = InputBox("Ingrese la cantidad de dolares a convertir")
                    newMoneda = moneda * 0.9
                    MsgBox("La conversion de " & moneda & " dolares a euros son: $" & newMoneda)
                Case 3
                    moneda = InputBox("Ingrese la cantidad de dolares a convertir")
                    newMoneda = moneda * 121.9
                    MsgBox("La conversion de " & moneda & " dolares a Yenes son: $" & newMoneda)
                Case 4
                    moneda = InputBox("Ingrese la cantidad de Yenes a convertir")
                    newMoneda = moneda * 0.0082
                    MsgBox("La conversion de " & moneda & " Yenes a dolares son: $" & newMoneda)
                Case 5
                    moneda = InputBox("Ingrese la cantidad de dolares a convertir")
                    newMoneda = moneda * 149.149
                    MsgBox("La conversion de " & moneda & " dolares a pesetas son: $" & newMoneda)
                Case 6
                    moneda = InputBox("Ingrese la cantidad de pesetas a convertir")
                    newMoneda = moneda * 0.0067
                    MsgBox("La conversion de " & moneda & " pesetas a dolares son: $" & newMoneda)
                Case 7
                    moneda = InputBox("Ingrese la cantidad de dolares a convertir")
                    newMoneda = moneda * 0.76
                    MsgBox("La conversion de " & moneda & " dolares a libras esterlinas son: $" & newMoneda)
                Case 8
                    moneda = InputBox("Ingrese la cantidad de libras esterlinas a convertir")
                    newMoneda = moneda * 1.31
                    MsgBox("La conversion de " & moneda & " libras esterlinas a dolares son: $" & newMoneda)
            End Select
